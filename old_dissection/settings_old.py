...
MODEL = 'resnet18'                          # model arch: resnet18, resnet50, alexnet, vgg16, densenet161, custom
DATASET = 'places_coffeeshop_restaurant'    # model trained on: places365, imagenet, imagenette, imagewoof, indoor, places
...
MODEL_FILE = 'zoo/model.pth'   # 'zoo/' + MODEL + '_' + DATASET + '.pth'
MODEL_PARALLEL = False

if MODEL == 'resnet18':
    FEATURE_NAMES = ['layer4.1.conv2']
    #if DATASET == 'places365':
    ...
    #if DATASET == 'cifar10':
    #    MODEL_FILE = 'zoo/custom_cifar10.pth.tar'
    #    MODEL_PARALLEL = False
